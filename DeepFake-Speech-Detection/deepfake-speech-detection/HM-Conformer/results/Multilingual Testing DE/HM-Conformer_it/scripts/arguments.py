...
def get_args():
    ...
    system_args = {
        # expeirment info
        'project'       : 'Multilingual Testing DE',
        'name'          : 'HM-Conformer_it',
        'tags'          : [],
        'description'   : '',
        ...
        'selected_language': 'it',  # Filter for English only. Change to other language codes (e.g., 'it', 'es') or None for all languages
    ...
    args['path_params'] = '/content/deepfake-speech-detection/HM-Conformer/results/Multilingual Training/HM-Conformer_de/models'
